...
public class JDBCDemo {
	...
	public static void main(String[] args) {
        ...
        try {
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/demo", "root", "Addicto@3012");
                ...
                switch (choice) {
                    ...
                    case 4:
                        ...
                        if (attributeChoice == 1) {
                            ...
                            res = s.executeUpdate("update parts set p_name = '" + newPartName + "' where pid = " + updateId);
